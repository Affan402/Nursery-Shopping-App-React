...
function ProductList({onHomeClick}) {
    ...
    return (
        <div>
            {/*Navbar*/}
            <div className="bg-[#4CAF50] text-white p-[15px] flex justify-between items-center text-[20px] ">
                <div className="tag width-[400px] flex items-center justify-center">
                    <div className="flex items-center justify-center gap-4 ">
                        <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="" className="h-[70px] w-[70px] rounded-full object-cover"/>
                        <a href="/" className="no-underline" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 className="text-white text-[30px]">Paradise Nursery</h3>                            
                                <i className="text-white">Where Green Meets Serenity</i>
                            </div>
                        </a>
                    </div>
                </div>
                <div className="flex justify-between items-center mx-auto max-w-[1100px] w-full">
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} className="text-white text-[30px] no-underline">
                            <h1 className='cart flex items-center'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" className="h-[68px] w-[68px]">
