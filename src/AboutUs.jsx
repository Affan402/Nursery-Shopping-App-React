...
function AboutUs() {
    return (
        <div className="max-w-[1000px] p-[20px] mx-auto text-gray-300 text-justify">
            {/* <h1 className="about-us-heading">About Us</h1> */}
            <p className="text-lg  mb-[30px] text-center">Welcome to Paradise Nursery, where green meets serenity!</p>
